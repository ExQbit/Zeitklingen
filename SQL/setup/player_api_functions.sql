-- Supabase API-Funktionen für die Verwaltung von Spielerdaten

-- Funktion zum Abrufen aller Daten eines Spielers
...
RETURNS TABLE (
    ...
    SELECT * FROM public.player_data WHERE player_id = p_player_id;
$$;
