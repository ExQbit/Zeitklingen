-- Überarbeitete Version der API-Funktionen für Spielerdaten
-- Die get_player_data-Funktion wurde bereits installiert und wird daher übersprungen
...
SELECT 'Alle verbleibenden API-Funktionen für Spielerdaten wurden erfolgreich installiert.' AS message;
